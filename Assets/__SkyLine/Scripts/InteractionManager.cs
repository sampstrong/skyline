...
namespace Buck
{
    ...
    public class InteractionManager : Singleton<InteractionManager>
    {
        ...
        /// <summary>
        /// List of current RaycastHits
        /// Added access to allow other classes to Set the current placeable with the current hit pose data.
        /// </summary>
        public List<ARRaycastHit> Hits { get => _hits; }
