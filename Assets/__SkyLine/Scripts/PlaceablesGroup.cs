...
namespace Buck
{
    ...
    public class PlaceablesGroup : MonoBehaviour
    {
        ...
        /// </summary>
        public virtual void Init(bool usingTerrainAnchor = false)
        {
            _isInit = true;

            if (usingTerrainAnchor)
            {
                AttachToNewGeoAnchor(TerrainAnchorManager.Instance.CurrentAnchor);
            }
            else
            {
        ...
        public void DetachWhenTargetReached()
        {
            GeospatialManager.Instance.TargetAccuracyReached.AddListener(DetachFromGeoAnchor);
        }
        ...
        /// </summary>
        public void DetachFromGeoAnchor() // changed from protected to public
        {
