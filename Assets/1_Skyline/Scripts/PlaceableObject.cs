...
namespace Buck
{
    ...
    {
        protected event Action<PlaceableState> onPlaceableStateChanged; 

        public PlaceablesGroup Group { get => _group; }
        ...
        {
            SetPlaceableObjectData(prefabIndex);
        ...
        public void SetPlaceableObjectData(int prefabIndex)
        {
        ...
        protected virtual void RegisterWithPlaceablesGroup(PlaceablesGroup group)
        {
            ...
            // Debug.Log($"Placeable Group Set: {_group.name}");
        }
        ...
        {
            // Debug.Log($"Placeable Object: OnInteractionStateChanged() Invoked: {placingState}");
        ...
        {
            // Debug.Log("Set Up Renderers Invoked");
           ...
           // {
           //     Debug.Log($"Original Materials: {mat.name}");
           // }
        ...
        protected virtual void SetMaterials(Material material = null)
        {
            for (int i = 0; i < _renderers.Length; i++)
            {
                ...
                // Debug.Log($"Material: {_renderers[i].material}");
            }
